    ...
    return props.stateModal && (
        createPortal(
            <>
                ...
                <div className="absolute top-1/2 left-1/2 z-30 bg-form-background w-full h-auto max-w-72 md:max-w-[335px] rounded-lg transform -translate-x-1/2 -translate-y-1/2 px-2 py-2 md:px-4 md:py-4">
